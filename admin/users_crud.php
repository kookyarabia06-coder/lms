...
<input name="departments" class="form-control mb-3" placeholder="Department">
...
<td><?= htmlspecialchars($u['username']) ?></td>
<td><?= htmlspecialchars($u['fname'] . ' ' . $u['lname']) ?></td>
<td><?= htmlspecialchars($u['departments']) ?></td>
<td><?= htmlspecialchars($u['email']) ?></td>
<td>
<?php if ($u['role'] === 'admin'): ?>
...
On Thu, Feb 19, 2026 at 10:49 AM For Github <fgithub455@gmail.com> wrote:
<?php
