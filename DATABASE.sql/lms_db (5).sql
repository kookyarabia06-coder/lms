...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2026 at 08:13 AM
...
(13, 62, 'For Testing Assessment', 'For Testing Only', 70, 1, 1, '2026-04-21 01:55:23', '2026-04-21 05:33:55');
...
(36, 25, 59, 231, NULL, 1, 1),
(37, 25, 60, 236, NULL, 1, 1),
(38, 25, 61, 241, NULL, 1, 1),
(39, 25, 62, 246, NULL, 1, 1);
...
(9, 10, 76, 50.00, 'completed', '2026-04-10 14:39:27', '2026-04-10 14:39:36', 0, NULL),
(10, 10, 76, 0.00, 'completed', '2026-04-10 14:40:17', '2026-04-10 14:40:27', 0, NULL),
(11, 10, 76, 50.00, 'completed', '2026-04-10 14:43:03', '2026-04-10 14:45:04', 0, NULL),
(12, 10, 76, 100.00, 'completed', '2026-04-10 15:00:49', '2026-04-10 15:00:56', 1, NULL),
(14, 11, 105, 0.00, 'completed', '2026-04-13 10:31:02', '2026-04-13 10:32:12', 0, NULL),
(18, 12, 76, 100.00, 'completed', '2026-04-13 10:51:49', '2026-04-13 10:51:52', 1, NULL),
(19, 12, 106, 0.00, 'completed', '2026-04-13 10:52:51', '2026-04-13 10:52:55', 0, NULL),
(25, 13, 76, 100.00, 'completed', '2026-04-23 11:19:14', '2026-04-23 11:19:28', 1, NULL);
...
(59, 13, 'ANSWER IS A', 'multiple_choice', 1, 0, '2026-04-21 05:33:55'),
(60, 13, 'ANSWER IS B', 'multiple_choice', 1, 1, '2026-04-21 05:33:55'),
(61, 13, 'ANSWER IS C', 'multiple_choice', 1, 2, '2026-04-21 05:33:55'),
(62, 13, 'ANSWER IS D', 'multiple_choice', 1, 3, '2026-04-21 05:33:55');
...
(57, 'courses', 51, 'INSERT', NULL, '{\"title\": \"sample course\", \"description\": \"sample course\", \"summary\": \"sample coursesample course\", \"thumbnail\": \"593e9c95be78c85a.png\", \"file_pdf\": \"ac1f2676fec76fa3.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": \"2026-04-13\", \"is_active\": 1}', NULL, NULL, '2026-04-10 06:17:01'),
(58, 'courses', 52, 'INSERT', NULL, '{\"title\": \"course ni mika\", \"description\": \"pag aaralan si mika\", \"summary\": \"study about mika\'s life and generate something\", \"thumbnail\": null, \"file_pdf\": null, \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-13 02:21:38'),
(59, 'courses', 53, 'INSERT', NULL, '{\"title\": \"asdsadsasa\", \"description\": \"sadsadsad\", \"summary\": \"sdsadasdasda\", \"thumbnail\": null, \"file_pdf\": null, \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-13 02:35:17'),
(60, 'courses', 53, 'DELETE', '{\"title\": \"asdsadsasa\", \"description\": \"sadsadsad\", \"summary\": \"sdsadasdasda\", \"thumbnail\": null, \"file_pdf\": null, \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, NULL, '2026-04-21 01:25:06'),
(61, 'courses', 52, 'DELETE', '{\"title\": \"course ni mika\", \"description\": \"pag aaralan si mika\", \"summary\": \"study about mika\'s life and generate something\", \"thumbnail\": null, \"file_pdf\": null, \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, NULL, '2026-04-21 01:25:09'),
(62, 'courses', 51, 'DELETE', '{\"title\": \"sample course\", \"description\": \"sample course\", \"summary\": \"sample coursesample course\", \"thumbnail\": \"593e9c95be78c85a.png\", \"file_pdf\": \"ac1f2676fec76fa3.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": \"2026-04-13\", \"is_active\": 1}', NULL, NULL, NULL, '2026-04-21 01:25:12'),
(63, 'courses', 44, 'UPDATE', '{\"title\": \"MS Powerpoint\", \"description\": \"MS PowerpointMS Powerpoint\", \"summary\": \"MS PowerpointMS PowerpointMS Powerpoint\", \"thumbnail\": \"787649e329f7066e.png\", \"file_pdf\": \"2511cc375026c19b.pdf\", \"file_video\": \"3734cd9963722805.mp4\", \"expires_at\": null, \"is_active\": 1}', '{\"title\": \"MS Powerpoint\", \"description\": \"MS PowerpointMS Powerpoint\", \"summary\": \"MS PowerpointMS PowerpointMS Powerpoint\", \"thumbnail\": \"eb6ee70b319faea6.png\", \"file_pdf\": \"4f55ab87651aaeaf.pdf\", \"file_video\": \"3734cd9963722805.mp4\", \"expires_at\": null, \"is_active\": 1}', '[\"thumbnail\", \"file_pdf\"]', NULL, '2026-04-21 01:27:44'),
(64, 'courses', 54, 'INSERT', NULL, '{\"title\": \"MS Word\", \"description\": \"Microsoft Word is a graphical word processing software developed by Microsoft that allows users to create, edit, format, and save text-based documents. Originally released in 1983 as \\\"Multi-Tool Word,\\\" it has since become the industry standard for document creation.\", \"summary\": \"Microsoft Word is a word processing software developed by Microsoft that allows users to create, edit, format, and share documents efficiently. It is part of the Microsoft Office suite and is widely used in academic, professional, and personal settings.\\r\\n\\r\\nThis module covers the basic to intermediate features of Microsoft Word, including navigating the interface, creating and saving documents, and using formatting tools such as fonts, paragraphs, and styles. It also introduces more advanced functions like inserting tables, images, shapes, headers and footers, and page numbers to enhance document presentation.\\r\\n\\r\\nAdditionally, users learn how to use editing and reviewing tools such as spell check, grammar suggestions, track changes, and comments, which are essential for collaboration. The module may also include lessons on templates, document layout, printing, and exporting files into different formats like PDF.\\r\\n\\r\\nBy the end of the module, learners should be able to produce well-structured, professional-looking documents and apply Word’s features to improve productivity and communication.\", \"thumbnail\": \"840b6aba9bfd3c4e.webp\", \"file_pdf\": \"5a050bc25d95e7e4.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:31:22'),
(65, 'courses', 55, 'INSERT', NULL, '{\"title\": \"MS Excel\", \"description\": \"An Excel module typically consists of a Module Description, which provides a high-level overview of the topics covered, and a Module Summary, which highlights the key takeaways and learning outcomes.\", \"summary\": \"This module provides a comprehensive introduction to Microsoft Excel, focusing on the fundamental skills required to organize, calculate, and analyze data efficiently. You will begin by navigating the Excel interface—including the ribbon, worksheets, and cells—before moving into data entry and essential formatting techniques to improve readability. A key focus of the training is mastering core formulas and built-in functions like SUM, AVERAGE, and IF to automate basic arithmetic and logical calculations. By the end of the module, you will be equipped to transform raw datasets into clear visual summaries using charts and tables, enabling you to present data-driven insights with confidence in any professional or academic setting.\", \"thumbnail\": \"853a7aa56a8c8b79.webp\", \"file_pdf\": \"5f3636caae91db58.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:33:31'),
(66, 'courses', 56, 'INSERT', NULL, '{\"title\": \"Adobe Photoshop\", \"description\": \"Adobe Photoshop is a powerful graphics editing program developed by Adobe Inc., widely used for photo editing, digital art, and design. This module introduces learners to the essential tools and techniques needed to create and enhance visual content.\", \"summary\": \"The module begins with an overview of the Photoshop interface, including panels, toolbars, and workspace customization. Students learn basic skills such as opening and saving files, working with different image formats, and using fundamental tools like selection, crop, brush, and text tools.\\r\\n\\r\\nAs the module progresses, learners explore more advanced features such as layers, masks, blending modes, and adjustments for color correction and image enhancement. It also covers retouching techniques, applying filters and effects, and creating compositions by combining multiple images.\\r\\n\\r\\nIn addition, the module introduces design principles and workflow practices to help users produce professional-quality graphics for print and digital media. By the end of the course, learners shoul\", \"thumbnail\": \"c73646112cd45615.jpg\", \"file_pdf\": \"50db9921275a8ba3.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:36:30'),
(67, 'courses', 57, 'INSERT', NULL, '{\"title\": \"Republic Act No. 11313\", \"description\": \"Republic Act No. 11313, also known as the Safe Spaces Act or “Bawal Bastos Law,” is a Philippine law that aims to prevent and penalize gender-based sexual harassment in public spaces, workplaces, educational institutions, and online platforms.\", \"summary\": \"This law expands the definition of sexual harassment beyond traditional settings by addressing inappropriate behavior in streets and other public areas. It includes acts such as catcalling, wolf-whistling, unwanted comments, gestures, stalking, and online harassment that cause discomfort or fear.\\r\\n\\r\\nThe Act applies to all individuals regardless of gender and emphasizes respect, dignity, and equality. It mandates institutions, employers, and local government units to implement policies, reporting systems, and awareness programs to ensure safe environments.\\r\\n\\r\\nPenalties under the law vary depending on the severity and frequency of the offense, ranging from fines and community service to imprisonment. It also provides protection and support for victims, encouraging them to report incidents without fear of retaliation.\\r\\n\\r\\nBy enforcing stricter measures against harassment, the law promotes safer public and private spaces and fosters a culture of accountability and mutual respect.\", \"thumbnail\": \"971f0980bf0edf09.jpg\", \"file_pdf\": \"7aabd5fc8eece9e6.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:41:22'),
(68, 'courses', 58, 'INSERT', NULL, '{\"title\": \"Microsoft Company\", \"description\": \"Microsoft is a global technology company founded in 1975 by Bill Gates and Paul Allen. It is headquartered in Redmond, Washington and is one of the world’s leading developers of software, hardware, and digital services.\", \"summary\": \"Microsoft is best known for its flagship products such as the Microsoft Windows operating system and Microsoft Office applications, which include Word, Excel, and PowerPoint. The company also develops cloud computing services through Microsoft Azure, as well as hardware like the Surface devices and Xbox gaming consoles.\\r\\n\\r\\nOver the years, Microsoft has played a major role in shaping the technology industry by making computers more accessible and improving productivity tools for individuals and businesses. Today, it continues to innovate in areas such as artificial intelligence, cloud computing, and digital collaboration.\\r\\n\\r\\nOverall, Microsoft is recognized as one of the most influential and valuable technology companies in the world, impacting how people work, communicate, and use technology daily.\", \"thumbnail\": \"57fa01fc4a8817bf.jpg\", \"file_pdf\": \"ddf79fdec0be0ef0.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:43:03'),
(69, 'courses', 59, 'INSERT', NULL, '{\"title\": \"Microsoft Operating System (Windows)\", \"description\": \"The primary operating system developed by Microsoft is Microsoft Windows. It is a system software that manages computer hardware and software resources while providing a user-friendly interface for interaction.\", \"summary\": \"Microsoft Windows allows users to perform tasks such as running applications, managing files, browsing the internet, and customizing system settings. It features a graphical user interface (GUI) that includes elements like the desktop, taskbar, icons, and start menu, making it easy to navigate even for beginners.\\r\\n\\r\\nOver the years, Windows has evolved through multiple versions, including Windows 7, Windows 10, and Windows 11, each offering improved performance, security, and features.\\r\\n\\r\\nWindows is widely used in homes, schools, and businesses due to its compatibility with a large variety of software and hardware. It also supports multitasking, networking, and security features that help users work efficiently and safely.\\r\\n\\r\\nOverall, Microsoft Windows is one of the most popular operating systems in the world, playing a key role in everyday computing.\", \"thumbnail\": \"4d572450d250e404.jpg\", \"file_pdf\": \"7126d8bfa6d52844.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:45:14'),
(70, 'courses', 60, 'INSERT', NULL, '{\"title\": \"Basic Desktop Computer Hardware Troubleshooting\", \"description\": \"Basic desktop computer hardware troubleshooting involves identifying, diagnosing, and resolving common physical issues that affect a computer’s performance. It focuses on essential components such as the processor, memory (RAM), hard drive, power supply, monitor, keyboard, and mouse.\", \"summary\": \"This module teaches learners how to recognize common problems, such as a computer not turning on, no display on the monitor, unusual noises, overheating, or unresponsive peripherals. It also covers simple diagnostic steps like checking cable connections, ensuring proper power supply, cleaning internal components, and testing hardware parts.\\r\\n\\r\\nStudents are introduced to safe troubleshooting practices, including proper handling of components, unplugging devices before inspection, and avoiding static electricity damage. Basic tools and techniques, such as using diagnostic software or replacing faulty parts, may also be included.\\r\\n\\r\\nBy the end of the module, learners should be able to systematically identify hardware issues, apply basic solutions, and determine when professional repair is needed, helping maintain a computer’s functionality and lifespan.\", \"thumbnail\": \"310416b016d9fddb.jpg\", \"file_pdf\": \"bd0252fe00f39dc6.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:46:46');
INSERT INTO `audit_log` (`id`, `table_name`, `record_id`, `action`, `old_data`, `new_data`, `changed_fields`, `user_id`, `created_at`) VALUES
(71, 'courses', 61, 'INSERT', NULL, '{\"title\": \"OS Formatting and Installation\", \"description\": \"OS formatting and installation refer to the process of preparing a computer’s storage device and installing an operating system such as Microsoft Windows. Formatting involves erasing existing data on a hard drive or partition and setting up a file system so it can store new data properly.\", \"summary\": \"This module teaches the step-by-step process of installing an operating system, including creating a bootable installation media (USB or DVD), configuring BIOS/UEFI settings, and running the installation setup. Learners are guided on how to partition drives, select installation options, and complete system setup.\\r\\n\\r\\nIt also covers important preparation steps such as backing up files, checking system requirements, and ensuring drivers are available. Post-installation tasks like installing drivers, updates, and essential software are also included to ensure the system runs smoothly.\\r\\n\\r\\nAdditionally, the module emphasizes safety and accuracy to prevent data loss and system errors. By the end of the module, learners should be able to confidently format a computer and install an operating system, making the device ready for use.\", \"thumbnail\": \"c9cc01bfa5da2cbd.jpg\", \"file_pdf\": \"42fa4a7343d51610.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:48:43'),
(72, 'courses', 62, 'INSERT', NULL, '{\"title\": \"For Testing\", \"description\": \"For test only\", \"summary\": \"For test only\", \"thumbnail\": \"913eb3147618e820.jpg\", \"file_pdf\": \"ff89baad0d5c836c.pdf\", \"file_video\": null, \"proponent_id\": 22, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, '2026-04-21 01:54:18'),
(73, 'courses', 46, 'DELETE', '{\"title\": \"BASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTING\", \"description\": \"BASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTING\", \"summary\": \"BASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTINGBASIC DESKTOP COMPUTER HARDWARE TROUBLESHOOTING\", \"thumbnail\": null, \"file_pdf\": \"553d0b74f1e03290.pdf\", \"file_video\": null, \"proponent_id\": 5, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, NULL, '2026-04-21 02:18:54'),
(74, 'courses', 47, 'DELETE', '{\"title\": \"MS WORD\", \"description\": \"MS WORDMS WORD\", \"summary\": \"MS WORDMS WORDMS WORDMS WORDMS WORDMS WORD\", \"thumbnail\": null, \"file_pdf\": \"0c8a2d5f9d024c5f.pdf\", \"file_video\": \"e8483caa3dd5f146.mp4\", \"proponent_id\": 5, \"expires_at\": null, \"is_active\": 1}', NULL, NULL, NULL, '2026-04-21 02:21:02'),
(75, 'courses', 44, 'UPDATE', '{\"title\": \"MS Powerpoint\", \"description\": \"MS PowerpointMS Powerpoint\", \"summary\": \"MS PowerpointMS PowerpointMS Powerpoint\", \"thumbnail\": \"eb6ee70b319faea6.png\", \"file_pdf\": \"4f55ab87651aaeaf.pdf\", \"file_video\": \"3734cd9963722805.mp4\", \"expires_at\": null, \"is_active\": 1}', '{\"title\": \"MS Powerpoint\", \"description\": \"MS PowerpointMS Powerpoint\", \"summary\": \"MS PowerpointMS PowerpointMS Powerpoint\", \"thumbnail\": \"98cb160632c3f193.jpg\", \"file_pdf\": \"4f55ab87651aaeaf.pdf\", \"file_video\": \"3734cd9963722805.mp4\", \"expires_at\": null, \"is_active\": 1}', '[\"thumbnail\"]', NULL, '2026-04-21 02:29:40'),
(76, 'courses', 56, 'UPDATE', '{\"title\": \"Adobe Photoshop\", \"description\": \"Adobe Photoshop is a powerful graphics editing program developed by Adobe Inc., widely used for photo editing, digital art, and design. This module introduces learners to the essential tools and techniques needed to create and enhance visual content.\", \"summary\": \"The module begins with an overview of the Photoshop interface, including panels, toolbars, and workspace customization. Students learn basic skills such as opening and saving files, working with different image formats, and using fundamental tools like selection, crop, brush, and text tools.\\r\\n\\r\\nAs the module progresses, learners explore more advanced features such as layers, masks, blending modes, and adjustments for color correction and image enhancement. It also covers retouching techniques, applying filters and effects, and creating compositions by combining multiple images.\\r\\n\\r\\nIn addition, the module introduces design principles and workflow practices to help users produce professional-quality graphics for print and digital media. By the end of the course, learners shoul\", \"thumbnail\": \"c73646112cd45615.jpg\", \"file_pdf\": \"50db9921275a8ba3.pdf\", \"file_video\": null, \"expires_at\": null, \"is_active\": 1}', '{\"title\": \"Adobe Photoshop!\", \"description\": \"Adobe Photoshop is a powerful graphics editing program developed by Adobe Inc., widely used for photo editing, digital art, and design. This module introduces learners to the essential tools and techniques needed to create and enhance visual content.\", \"summary\": \"The module begins with an overview of the Photoshop interface, including panels, toolbars, and workspace customization. Students learn basic skills such as opening and saving files, working with different image formats, and using fundamental tools like selection, crop, brush, and text tools.\\r\\n\\r\\nAs the module progresses, learners explore more advanced features such as layers, masks, blending modes, and adjustments for color correction and image enhancement. It also covers retouching techniques, applying filters and effects, and creating compositions by combining multiple images.\\r\\n\\r\\nIn addition, the module introduces design principles and workflow practices to help users produce professional-quality graphics for print and digital media. By the end of the course, learners shoul\", \"thumbnail\": \"c73646112cd45615.jpg\", \"file_pdf\": \"50db9921275a8ba3.pdf\", \"file_video\": null, \"expires_at\": null, \"is_active\": 1}', '[\"title\"]', NULL, '2026-04-21 05:57:12');
...
CREATE TABLE `courses` (
  ...
  `badge_issued` blob DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `courses` (`id`, `title`, `description`, `thumbnail`, `proponent_id`, `file_pdf`, `file_video`, `created_at`, `updated_at`, `expires_at`, `is_active`, `summary`, `edited_at`, `status`, `badge_issued`) VALUES
(44, 'MS Powerpoint', 'MS PowerpointMS Powerpoint', '98cb160632c3f193.jpg', 22, '4f55ab87651aaeaf.pdf', '3734cd9963722805.mp4', '2026-03-11 01:59:03', '2026-04-21 02:29:40', NULL, 1, 'MS PowerpointMS PowerpointMS Powerpoint', NULL, 'approve', NULL),
(54, 'MS Word', 'Microsoft Word is a graphical word processing software developed by Microsoft that allows users to create, edit, format, and save text-based documents. Originally released in 1983 as \"Multi-Tool Word,\" it has since become the industry standard for document creation.', '840b6aba9bfd3c4e.webp', 22, '5a050bc25d95e7e4.pdf', NULL, '2026-04-21 01:31:22', '2026-04-21 02:19:16', NULL, 1, 'Microsoft Word is a word processing software developed by Microsoft that allows users to create, edit, format, and share documents efficiently. It is part of the Microsoft Office suite and is widely used in academic, professional, and personal settings.\r\n\r\nThis module covers the basic to intermediate features of Microsoft Word, including navigating the interface, creating and saving documents, and using formatting tools such as fonts, paragraphs, and styles. It also introduces more advanced functions like inserting tables, images, shapes, headers and footers, and page numbers to enhance document presentation.\r\n\r\nAdditionally, users learn how to use editing and reviewing tools such as spell check, grammar suggestions, track changes, and comments, which are essential for collaboration. The module may also include lessons on templates, document layout, printing, and exporting files into different formats like PDF.\r\n\r\nBy the end of the module, learners should be able to produce well-structured, professional-looking documents and apply Word’s features to improve productivity and communication.', NULL, 'approve', NULL),
(55, 'MS Excel', 'An Excel module typically consists of a Module Description, which provides a high-level overview of the topics covered, and a Module Summary, which highlights the key takeaways and learning outcomes.', '853a7aa56a8c8b79.webp', 22, '5f3636caae91db58.pdf', NULL, '2026-04-21 01:33:31', '2026-04-21 02:19:18', NULL, 1, 'This module provides a comprehensive introduction to Microsoft Excel, focusing on the fundamental skills required to organize, calculate, and analyze data efficiently. You will begin by navigating the Excel interface—including the ribbon, worksheets, and cells—before moving into data entry and essential formatting techniques to improve readability. A key focus of the training is mastering core formulas and built-in functions like SUM, AVERAGE, and IF to automate basic arithmetic and logical calculations. By the end of the module, you will be equipped to transform raw datasets into clear visual summaries using charts and tables, enabling you to present data-driven insights with confidence in any professional or academic setting.', NULL, 'approve', NULL),
(56, 'Adobe Photoshop!', 'Adobe Photoshop is a powerful graphics editing program developed by Adobe Inc., widely used for photo editing, digital art, and design. This module introduces learners to the essential tools and techniques needed to create and enhance visual content.', 'c73646112cd45615.jpg', 22, '50db9921275a8ba3.pdf', NULL, '2026-04-21 01:36:30', '2026-04-21 06:08:12', NULL, 1, 'The module begins with an overview of the Photoshop interface, including panels, toolbars, and workspace customization. Students learn basic skills such as opening and saving files, working with different image formats, and using fundamental tools like selection, crop, brush, and text tools.\r\n\r\nAs the module progresses, learners explore more advanced features such as layers, masks, blending modes, and adjustments for color correction and image enhancement. It also covers retouching techniques, applying filters and effects, and creating compositions by combining multiple images.\r\n\r\nIn addition, the module introduces design principles and workflow practices to help users produce professional-quality graphics for print and digital media. By the end of the course, learners shoul', NULL, 'pending', NULL),
(57, 'Republic Act No. 11313', 'Republic Act No. 11313, also known as the Safe Spaces Act or “Bawal Bastos Law,” is a Philippine law that aims to prevent and penalize gender-based sexual harassment in public spaces, workplaces, educational institutions, and online platforms.', '971f0980bf0edf09.jpg', 22, '7aabd5fc8eece9e6.pdf', NULL, '2026-04-21 01:41:22', NULL, NULL, 1, 'This law expands the definition of sexual harassment beyond traditional settings by addressing inappropriate behavior in streets and other public areas. It includes acts such as catcalling, wolf-whistling, unwanted comments, gestures, stalking, and online harassment that cause discomfort or fear.\r\n\r\nThe Act applies to all individuals regardless of gender and emphasizes respect, dignity, and equality. It mandates institutions, employers, and local government units to implement policies, reporting systems, and awareness programs to ensure safe environments.\r\n\r\nPenalties under the law vary depending on the severity and frequency of the offense, ranging from fines and community service to imprisonment. It also provides protection and support for victims, encouraging them to report incidents without fear of retaliation.\r\n\r\nBy enforcing stricter measures against harassment, the law promotes safer public and private spaces and fosters a culture of accountability and mutual respect.', NULL, 'pending', NULL),
(58, 'Microsoft Company', 'Microsoft is a global technology company founded in 1975 by Bill Gates and Paul Allen. It is headquartered in Redmond, Washington and is one of the world’s leading developers of software, hardware, and digital services.', '57fa01fc4a8817bf.jpg', 22, 'ddf79fdec0be0ef0.pdf', NULL, '2026-04-21 01:43:03', NULL, NULL, 1, 'Microsoft is best known for its flagship products such as the Microsoft Windows operating system and Microsoft Office applications, which include Word, Excel, and PowerPoint. The company also develops cloud computing services through Microsoft Azure, as well as hardware like the Surface devices and Xbox gaming consoles.\r\n\r\nOver the years, Microsoft has played a major role in shaping the technology industry by making computers more accessible and improving productivity tools for individuals and businesses. Today, it continues to innovate in areas such as artificial intelligence, cloud computing, and digital collaboration.\r\n\r\nOverall, Microsoft is recognized as one of the most influential and valuable technology companies in the world, impacting how people work, communicate, and use technology daily.', NULL, 'pending', NULL),
(59, 'Microsoft Operating System (Windows)', 'The primary operating system developed by Microsoft is Microsoft Windows. It is a system software that manages computer hardware and software resources while providing a user-friendly interface for interaction.', '4d572450d250e404.jpg', 22, '7126d8bfa6d52844.pdf', NULL, '2026-04-21 01:45:14', NULL, NULL, 1, 'Microsoft Windows allows users to perform tasks such as running applications, managing files, browsing the internet, and customizing system settings. It features a graphical user interface (GUI) that includes elements like the desktop, taskbar, icons, and start menu, making it easy to navigate even for beginners.\r\n\r\nOver the years, Windows has evolved through multiple versions, including Windows 7, Windows 10, and Windows 11, each offering improved performance, security, and features.\r\n\r\nWindows is widely used in homes, schools, and businesses due to its compatibility with a large variety of software and hardware. It also supports multitasking, networking, and security features that help users work efficiently and safely.\r\n\r\nOverall, Microsoft Windows is one of the most popular operating systems in the world, playing a key role in everyday computing.', NULL, 'pending', NULL),
(60, 'Basic Desktop Computer Hardware Troubleshooting', 'Basic desktop computer hardware troubleshooting involves identifying, diagnosing, and resolving common physical issues that affect a computer’s performance. It focuses on essential components such as the processor, memory (RAM), hard drive, power supply, monitor, keyboard, and mouse.', '310416b016d9fddb.jpg', 22, 'bd0252fe00f39dc6.pdf', NULL, '2026-04-21 01:46:46', NULL, NULL, 1, 'This module teaches learners how to recognize common problems, such as a computer not turning on, no display on the monitor, unusual noises, overheating, or unresponsive peripherals. It also covers simple diagnostic steps like checking cable connections, ensuring proper power supply, cleaning internal components, and testing hardware parts.\r\n\r\nStudents are introduced to safe troubleshooting practices, including proper handling of components, unplugging devices before inspection, and avoiding static electricity damage. Basic tools and techniques, such as using diagnostic software or replacing faulty parts, may also be included.\r\n\r\nBy the end of the module, learners should be able to systematically identify hardware issues, apply basic solutions, and determine when professional repair is needed, helping maintain a computer’s functionality and lifespan.', NULL, 'pending', NULL),
(61, 'OS Formatting and Installation', 'OS formatting and installation refer to the process of preparing a computer’s storage device and installing an operating system such as Microsoft Windows. Formatting involves erasing existing data on a hard drive or partition and setting up a file system so it can store new data properly.', 'c9cc01bfa5da2cbd.jpg', 22, '42fa4a7343d51610.pdf', NULL, '2026-04-21 01:48:43', NULL, NULL, 1, 'This module teaches the step-by-step process of installing an operating system, including creating a bootable installation media (USB or DVD), configuring BIOS/UEFI settings, and running the installation setup. Learners are guided on how to partition drives, select installation options, and complete system setup.\r\n\r\nIt also covers important preparation steps such as backing up files, checking system requirements, and ensuring drivers are available. Post-installation tasks like installing drivers, updates, and essential software are also included to ensure the system runs smoothly.\r\n\r\nAdditionally, the module emphasizes safety and accuracy to prevent data loss and system errors. By the end of the module, learners should be able to confidently format a computer and install an operating system, making the device ready for use.', NULL, 'pending', NULL),
(62, 'For Testing', 'For test only', '913eb3147618e820.jpg', 22, 'ff89baad0d5c836c.pdf', NULL, '2026-04-21 01:54:18', '2026-04-21 02:38:54', NULL, 1, 'For test only', NULL, 'approve', NULL);
...
INSERT INTO `enrollments` (`id`, `user_id`, `course_id`, `enrolled_at`, `completed_at`, `expired_at`, `progress`, `video_progress`, `pdf_progress`, `video_completed`, `pdf_completed`, `pdf_current_page`, `pdf_total_pages`, `status`, `total_time_seconds`, `badge_issued`) VALUES
(83, 76, 62, '2026-04-22 07:47:29', '2026-04-23 03:19:50', NULL, 100.00, 0, 0, 0, 1, 4, 4, 'completed', 0, NULL);
...
(3, 'ARMMC Handbook', '', '97890d00bddfe89f.png', NULL, NULL, 22, 22, '2026-04-21 02:06:58', NULL),
(4, 'ARMMC Document Tracking System Manual', '', '58388dfba2faba10.png', '9e98214b458bf1b7.pdf', NULL, 5, NULL, '2026-04-21 03:14:13', NULL),
(5, 'ARMMC Mitel User Guide for 6940w IP Phone', '', '65bab0c42164d321.webp', '2726eaf1695c3e2b.pdf', NULL, 5, NULL, '2026-04-21 03:16:02', NULL),
(6, 'ARMMC Mitel User Guide for 6930w IP Phone', '', '71a8ceb3d7478288.jpg', 'badc83929fc61a91.pdf', NULL, 5, NULL, '2026-04-21 03:17:38', NULL),
(7, 'ARMMC Mitel User Guide for 6905w IP Phone', '', '9f44b494396196c9.jpg', 'd1817c6c7a3c65f2.pdf', NULL, 5, NULL, '2026-04-21 03:18:58', NULL);
...
(7, 4, 5, 0, 0, 0, 0, 0, 0, NULL, '2026-04-21 03:14:18'),
(8, 3, 5, 0, 0, 0, 0, 0, 0, NULL, '2026-04-22 07:44:12'),
(9, 6, 5, 0, 0, 0, 0, 0, 0, NULL, '2026-04-23 03:20:45'),
(10, 7, 22, 0, 0, 0, 0, 0, 0, NULL, '2026-04-24 04:54:18'),
(11, 7, 5, 0, 0, 0, 0, 0, 0, NULL, '2026-04-24 04:54:41');
...
INSERT INTO `news` (`id`, `title`, `body`, `created_by`, `created_at`, `is_published`, `updated_at`) VALUES
(1, 'This is News', 'is this new?', 1, '2026-02-03 23:41:35', 1, '2026-02-03 23:41:35'),
(3, 'asdasdad', 'asdasda', 5, '2026-02-12 19:50:05', 1, '2026-02-12 19:50:05'),
(4, 'jakshdkjashfkhakshfkjaksdhjasdhkasdha', 'jdskalhdkhaskhd', 5, '2026-02-12 23:23:28', 1, '2026-02-12 23:23:28'),
(7, 'adasdadasdasd ', 'adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd adasdadasdasd ', 72, '2026-03-12 19:28:22', 1, '2026-03-12 19:28:22');
...
(0, 73, 1, '2026-04-10 06:25:13'),
(0, 73, 2, '2026-04-10 06:25:13'),
(0, 73, 3, '2026-04-10 06:25:23'),
(0, 73, 4, '2026-04-10 06:25:30'),
(0, 73, 5, '2026-04-10 06:25:41'),
(0, 73, 6, '2026-04-10 06:27:43'),
(0, 73, 7, '2026-04-10 06:27:45'),
(0, 73, 8, '2026-04-10 06:27:49'),
(0, 73, 9, '2026-04-10 06:27:50'),
(0, 73, 10, '2026-04-10 06:27:51'),
(0, 73, 11, '2026-04-10 06:27:52'),
(0, 73, 13, '2026-04-10 06:27:53'),
(0, 73, 16, '2026-04-10 06:27:53'),
(0, 73, 19, '2026-04-10 06:27:53'),
(0, 73, 21, '2026-04-10 06:27:53'),
(0, 73, 27, '2026-04-10 06:27:53'),
(0, 73, 33, '2026-04-10 06:27:53'),
(0, 73, 41, '2026-04-10 06:27:53'),
(0, 73, 45, '2026-04-10 06:27:53'),
(0, 73, 56, '2026-04-10 06:27:53'),
(0, 73, 63, '2026-04-10 06:27:53'),
(0, 73, 64, '2026-04-10 06:27:53'),
(0, 73, 66, '2026-04-10 06:27:53'),
(0, 73, 65, '2026-04-10 06:27:55'),
(0, 73, 62, '2026-04-10 06:27:59'),
(0, 73, 61, '2026-04-10 06:28:00'),
(0, 73, 60, '2026-04-10 06:28:00'),
(0, 73, 59, '2026-04-10 06:28:01'),
(0, 73, 58, '2026-04-10 06:28:02'),
(0, 73, 57, '2026-04-10 06:28:03'),
(0, 73, 55, '2026-04-10 06:28:10'),
(0, 73, 54, '2026-04-10 06:28:11'),
(0, 73, 53, '2026-04-10 06:29:03'),
(0, 73, 52, '2026-04-10 06:35:51'),
(0, 73, 51, '2026-04-10 06:35:51'),
(0, 73, 50, '2026-04-10 06:35:53'),
(0, 73, 49, '2026-04-10 06:35:54'),
(0, 73, 48, '2026-04-10 06:35:55'),
(0, 73, 47, '2026-04-10 06:35:56'),
(0, 73, 46, '2026-04-10 06:35:57'),
(0, 73, 44, '2026-04-10 06:35:59'),
(0, 73, 43, '2026-04-10 06:36:01'),
(0, 73, 42, '2026-04-10 06:36:02'),
(0, 73, 40, '2026-04-10 06:36:04'),
(0, 73, 39, '2026-04-10 06:36:05'),
(0, 73, 38, '2026-04-10 06:36:07'),
(0, 73, 37, '2026-04-10 06:36:08'),
(0, 73, 36, '2026-04-10 06:36:09'),
(0, 73, 35, '2026-04-10 06:36:11'),
(0, 73, 34, '2026-04-10 06:36:13'),
(0, 73, 32, '2026-04-10 06:36:16'),
(0, 73, 31, '2026-04-10 06:36:17'),
(0, 73, 30, '2026-04-10 06:36:18'),
(0, 73, 29, '2026-04-10 06:36:20'),
(0, 73, 28, '2026-04-10 06:36:21'),
(0, 73, 26, '2026-04-10 06:36:23'),
(0, 73, 25, '2026-04-10 06:36:24'),
(0, 73, 24, '2026-04-10 06:36:25'),
(0, 73, 23, '2026-04-10 06:36:27'),
(0, 73, 22, '2026-04-10 06:36:28'),
(0, 73, 20, '2026-04-10 06:36:31'),
(0, 73, 18, '2026-04-10 06:36:34'),
(0, 73, 17, '2026-04-10 06:36:35'),
(0, 73, 15, '2026-04-10 06:36:39'),
(0, 73, 14, '2026-04-10 06:36:39'),
(0, 73, 12, '2026-04-10 06:36:40'),
(0, 74, 1, '2026-04-13 01:54:22'),
(0, 74, 2, '2026-04-13 01:54:29'),
(0, 74, 3, '2026-04-13 01:54:31'),
(0, 74, 4, '2026-04-13 01:54:33'),
(0, 74, 5, '2026-04-13 01:54:35'),
(0, 74, 6, '2026-04-13 01:54:37'),
(0, 74, 7, '2026-04-13 01:54:39'),
(0, 74, 8, '2026-04-13 01:54:40'),
(0, 74, 9, '2026-04-13 01:54:42'),
(0, 74, 10, '2026-04-13 01:54:46'),
(0, 74, 11, '2026-04-13 02:00:51'),
(0, 74, 12, '2026-04-13 02:01:03'),
(0, 74, 13, '2026-04-13 02:04:19'),
(0, 74, 14, '2026-04-13 02:05:44'),
(0, 74, 15, '2026-04-13 02:06:29'),
(0, 74, 16, '2026-04-13 02:06:43'),
(0, 74, 17, '2026-04-13 02:06:55'),
(0, 79, 1, '2026-04-21 02:39:19'),
(0, 79, 2, '2026-04-21 03:08:43'),
(0, 79, 3, '2026-04-21 05:03:26'),
(0, 79, 4, '2026-04-21 05:03:34'),
(0, 80, 1, '2026-04-21 05:34:19'),
(0, 80, 2, '2026-04-21 05:34:24'),
(0, 80, 3, '2026-04-21 05:34:28'),
(0, 80, 4, '2026-04-21 05:34:33'),
(0, 81, 1, '2026-04-22 07:16:24'),
(0, 81, 2, '2026-04-22 07:16:29'),
(0, 81, 3, '2026-04-22 07:16:33'),
(0, 81, 4, '2026-04-22 07:16:36'),
(0, 82, 1, '2026-04-22 07:46:20'),
(0, 82, 2, '2026-04-22 07:46:27'),
(0, 82, 3, '2026-04-22 07:46:38'),
(0, 82, 4, '2026-04-22 07:46:45'),
(0, 83, 1, '2026-04-23 03:18:49'),
(0, 83, 2, '2026-04-23 03:18:53'),
(0, 83, 3, '2026-04-23 03:18:58'),
(0, 83, 4, '2026-04-23 03:19:08');

-- --------------------------------------------------------

--
-- Table structure for table `pm_training_attendance`
--

CREATE TABLE `pm_training_attendance` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pm_training_attendance`
--

INSERT INTO `pm_training_attendance` (`id`, `pm_training_request_id`, `user_id`, `attended`, `created_at`, `updated_at`) VALUES
(1, 1, 5, 1, '2026-04-07 10:12:27', '2026-04-07 10:30:58'),
(33, 3, 5, 0, '2026-04-07 16:51:18', NULL),
(91, 1, 76, 0, '2026-04-21 16:40:08', NULL),
(98, 23, 76, 0, '2026-04-23 17:35:27', NULL),
(101, 23, 106, 0, '2026-04-24 17:57:47', NULL),
(102, 23, 103, 0, '2026-04-24 17:57:47', NULL),
(103, 23, 89, 0, '2026-04-24 17:57:47', NULL),
(104, 23, 101, 0, '2026-04-24 17:57:47', NULL),
(105, 23, 107, 0, '2026-04-24 17:57:47', NULL),
(106, 23, 102, 0, '2026-04-24 17:57:47', NULL),
(107, 23, 77, 0, '2026-04-24 17:57:47', NULL),
(108, 23, 80, 0, '2026-04-24 17:57:47', NULL),
(109, 23, 81, 0, '2026-04-24 17:57:47', NULL),
(110, 23, 82, 0, '2026-04-24 17:57:47', NULL),
(111, 25, 103, 1, '2026-04-27 13:55:16', '2026-04-27 13:55:52'),
(112, 25, 101, 1, '2026-04-27 13:55:16', '2026-04-27 13:55:52'),
(113, 26, 103, 0, '2026-04-27 14:00:14', NULL),
(114, 26, 101, 0, '2026-04-27 14:00:14', NULL),
(115, 26, 107, 0, '2026-04-27 14:00:14', NULL),
(116, 26, 102, 0, '2026-04-27 14:00:14', NULL),
(117, 26, 76, 0, '2026-04-27 14:00:14', NULL),
(118, 27, 101, 0, '2026-04-27 14:01:11', NULL),
(119, 27, 107, 0, '2026-04-27 14:01:11', NULL),
(120, 27, 102, 0, '2026-04-27 14:01:11', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `pm_training_requests`
--

CREATE TABLE `pm_training_requests` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `pm_training_requests`
--

INSERT INTO `pm_training_requests` (`id`, `title`, `venue`, `date_start`, `date_end`, `hospital_order_no`, `amount`, `late_filing`, `remarks`, `requester_id`, `committee_id`, `ptr_file`, `attendance_file`, `status`, `created_at`, `updated_at`, `viewed_at`, `time_start`, `time_end`) VALUES
(1, 'title', 'bahay ni kooky', '2026-03-24', '2026-03-25', '', 2.00, 1, 'rename\r\n[Rescheduled: test]', 5, NULL, NULL, NULL, 'approved', '2026-04-07 10:12:27', '2026-04-22 10:00:40', '2026-04-22 10:00:40', NULL, NULL),
(3, 'adasdasdasd', 'bahay ni kooky', '2026-02-10', '2026-02-11', '', 23.00, 1, 'sadsadasdasd\r\n[Rescheduled: asdasd]\r\n[Rescheduled: asdasdas]\r\n[Rescheduled: test]', 1, 3, NULL, NULL, 'approved', '2026-04-07 16:51:18', '2026-04-24 17:57:07', '2026-04-22 10:00:40', NULL, NULL),
(23, 'Test1', 'Auditorium', '2026-05-01', '2026-05-02', '', 9999.97, 0, '{\"committee_id\":13,\"text\":\"\"}', 5, NULL, NULL, NULL, 'approved', '2026-04-23 17:35:27', '2026-04-24 10:55:01', '2026-04-24 10:55:01', '06:00:00', '08:00:00'),
(25, 'TEST2', 'Auditorium', '2026-04-25', '2026-04-26', '', 0.00, 0, '', 5, NULL, 'pm_training_1777269342_6a5dd5b3.png', NULL, 'complete', '2026-04-27 13:55:16', '2026-04-27 13:56:02', NULL, '13:50:00', '17:54:00'),
(26, 'test5', 'Auditorium', '2026-04-05', '2026-04-06', '', 0.00, 0, '', 5, 18, NULL, NULL, 'approved', '2026-04-27 14:00:14', '2026-04-27 14:01:37', '2026-04-27 14:01:37', '02:00:00', '07:00:00'),
(27, 'Pending', 'Auditorium', '2026-05-08', '2026-05-09', '', 0.00, 0, '', 5, NULL, NULL, NULL, 'pending', '2026-04-27 14:01:11', '2026-04-27 14:01:37', '2026-04-27 14:01:37', '14:00:00', '14:01:00');
...
INSERT INTO `training_requests` (`id`, `training_type`, `title`, `date_start`, `date_end`, `location_type`, `hospital_order_no`, `amount`, `late_filing`, `official_business`, `remarks`, `requester_id`, `resched_reason`, `ptr_file`, `coc_file`, `coa_file`, `mom_file`, `status`, `created_at`, `updated_at`, `viewed_at`) VALUES
(7, 'External', 'test1', '2026-02-10', '2026-03-11', 'local', '', 99999999.99, 0, 0, 'aeaqweqwew', 5, NULL, 'training_1776936692_e2406f25.png', 'training_1776936701_0e381834.png', NULL, NULL, 'complete', '2026-04-08 14:11:24', '2026-04-23 17:59:54', '2026-04-22 09:41:20'),
(9, 'External', 'qwewqeqwe', '2026-04-08', '2026-04-15', 'international', '', 99999999.99, 1, 1, '', 76, NULL, 'training_1776914134_cf6a74f4.png', 'training_1776914134_57f14e93.png', NULL, 'training_1776914134_c95788f0.png', 'complete', '2026-04-08 14:16:56', '2026-04-23 11:16:14', '2026-04-22 09:41:20'),
(10, 'External', 'asdasdasdad', '2026-04-05', '2026-04-07', '', '', 0.00, 0, 0, '', 76, NULL, 'training_1776914018_f23c6b54.pdf', 'training_1776914018_ab5c330c.pdf', NULL, 'training_1776914018_d95f5cde.pdf', 'complete', '2026-04-08 15:03:05', '2026-04-23 11:13:46', '2026-04-22 09:41:20'),
(11, 'External', 'sample request', '2026-04-11', '2026-04-17', 'local', '', 1000.00, 1, 0, 'Late Filing - heads up', 76, NULL, 'training_1776902140_fdb978e8.pdf', 'training_1776902140_2eb91c08.pdf', NULL, 'training_1776902140_404f931a.pdf', 'complete', '2026-04-10 14:50:29', '2026-04-23 07:55:40', '2026-04-22 09:41:20'),
(16, 'External', 'test2', '2026-03-04', '2026-03-05', 'local', '', 0.00, 0, 0, '', 5, 'test', NULL, NULL, NULL, NULL, 'approved', '2026-04-23 18:00:59', '2026-04-23 18:12:13', NULL),
(17, 'External', 'Test3', '2026-02-01', '2026-02-02', 'local', '', 0.00, 0, 0, '', 5, NULL, NULL, NULL, NULL, NULL, 'approved', '2026-04-23 18:11:50', '2026-04-23 18:12:02', NULL),
(18, 'External', 'Test4', '2026-04-27', '2026-04-28', 'local', '', 0.00, 0, 0, '', 5, NULL, NULL, NULL, NULL, NULL, 'pending', '2026-04-23 18:15:44', NULL, NULL);
...
CREATE TABLE `users` (
  ...
  `alt` enum('alt','pro') NOT NULL DEFAULT 'alt'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `users` (`id`, `username`, `password`, `fname`, `lname`, `email`, `role`, `created_at`, `updated_at`, `is_verified`, `otp_code`, `otp_expires_at`, `status`, `message_notifications`, `email_notifications`, `departments`, `alt`) VALUES
(1, 'kooky', '$2y$10$wjiEABSo/nLus0Nno0Y/dODGX6ZmNR6xkvmPGWndxaP4yZgBqpWja', 'Kooky', 'Arabia', 'Kookyarabia07@gmail.com', 'proponent', '2026-01-30 01:25:37', NULL, 0, '842486', '2026-02-04 12:00:52', 'confirmed', 1, 1, NULL, 'alt'),
(5, 'alvin', '$2y$10$p.0kdoyIco1ye14NdYTqY.FgdL3UF7Vpd/fo3rcEQEQo/qEhTATlO', 'Alvin', 'Lopez', 'traxcie21@gmail.com', 'admin', '2026-02-04 06:32:23', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(8, 'proponent', '$2y$10$YuqFFhnfrrPuXceFDMaVZugK18qFizJyOxrzKgrQX8nSkWRU4BLgW', 'Mr.', 'Proponent', 'proponent@gmail.com', 'proponent', '2026-02-11 00:43:36', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(22, 'pro', '$2y$10$gpII/P2uzcDch.35MinEve7EO4uQD05eaIkHpTshPmszmeMPArXaO', 'pro', 'pro', 'pro@gmail.com', 'proponent', '2026-02-16 05:15:51', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(72, 'superadmin', '$2y$10$L.sWs03m7FGhvcGQdRZ1JOditv/DeBO.OGiY.jIRfehV.bQLmnl5K', 'superadmin', 'superadmin', 'superadmin@mail.com', 'superadmin', '2026-03-12 03:04:11', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(76, 'user', '$2y$10$KwCQY6078.5GGWaXOWv3B.kxmomQZJYosIEpeN8YVJu8Yy.6Amysm', 'User', 'User', 'user@gmail.com', 'user', '2026-03-12 03:13:47', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(77, 'user1', '$2y$10$a1qcZxaMZ1Zq.miP/VB/luw5ia1i/rdDALUXHrtitWvsEJIbGiLL.', 'user1', 'user1', 'user1', 'user', '2026-03-12 03:14:38', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(80, 'user3', '$2y$10$51PKxLrYdyhsJeGEBcOsgOTWSxABDvFXFwFHZ1QB4ZEn1rGn6Nnnm', 'user3', 'user3', 'user3@mail.com', 'user', '2026-03-12 05:34:35', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(81, 'user4', '$2y$10$D0anqyyNSuFksYUpxdm6O.RwJa2f6WkRwxh.IGyffilA7e52l3MYu', 'user4', 'user4', 'user4@mail.zxc', 'user', '2026-03-12 05:34:59', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(82, 'user5', '$2y$10$byqELjtKf2ytKo0myGF.M.Y9RXN4G5sHGxHKRM/jwtMEvfHI7Gifi', 'user5', 'user5', 'user5@gmail.com', 'user', '2026-03-12 05:41:04', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(89, 'exampleuser', '$2y$10$5MR1AJsZvsCUIxYHfFiHquxH7BaZj7FpDTVjmI.FlH7omtQ.g9MHy', 'exampleuser', 'exampleuser', 'exampleuse@gmail.com', 'user', '2026-03-18 03:52:48', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(101, 'imman', '$2y$10$QV8OYKGPAauLwB/b4tXEPedtMbWNAnl7jR8pwXS0cFqhJOKiQkkd6', 'imman', 'imman', 'imman@pogidawsya.com', 'user', '2026-03-19 01:44:53', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(102, 'testdepartments', '$2y$10$koNC7D8un48YIl0hV9eaGOneqNTwNBjv4jmKne/f7c7OfvcHmbUiS', 'test', 'departments', 'gplankton1@gmail.com', 'user', '2026-03-19 03:56:36', NULL, 0, NULL, NULL, 'pending', 1, 1, NULL, 'alt'),
(103, 'alex', '$2y$10$0zckISlcAlkY4a4nn.GbeOFu8zui2LUE3q2l4IRGy.YArxUsLxCwi', 'Alex Marlo', 'Sacabon', 'sacabon.amv@gmail.com', 'user', '2026-04-10 07:43:28', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(104, 'alex-admin', '$2y$10$1bBcW0kiXwQnu0RLpZU.5.CKhQOo6TDUz0QIyDuPJYIC2kTDa/i/W', 'Alex Marlo', 'Sacabon', 'admin@test.com', 'admin', '2026-04-10 07:49:42', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(106, 'useruser', '$2y$10$yl6OZ7PZMKOdEbFoOrWcA.zwG4fCsrQW9GD0i0.9E3cGqUTZr6eoG', NULL, NULL, NULL, 'user', '2026-04-13 02:52:36', NULL, 0, NULL, NULL, 'confirmed', 1, 1, NULL, 'alt'),
(107, 'Aksoiemman1', '$2y$10$BbzVEX3MlHcDUzb24oluReFg3.Irg0pDkH4zU0nRLbCuECe7mfKxu', 'john', 'emmanuelle', 'gfaith209@gmail.com', 'user', '2026-04-23 04:10:10', NULL, 0, NULL, NULL, 'pending', 1, 1, NULL, 'alt');
...
(15, 103, 18, NULL, '2026-04-10 07:43:28'),
(16, 104, NULL, 4, '2026-04-10 07:49:42'),
(17, 104, NULL, 5, '2026-04-10 07:49:42'),
(18, 104, NULL, 6, '2026-04-10 07:49:42'),
(19, 22, NULL, 3, '2026-04-21 01:30:21'),
(20, 22, NULL, 4, '2026-04-21 01:30:21'),
(21, 22, NULL, 16, '2026-04-21 01:30:21'),
(22, 22, NULL, 22, '2026-04-21 01:30:21'),
(23, 107, 57, NULL, '2026-04-23 04:10:10');
...
ALTER TABLE `course_departments`
  ...
  ADD KEY `course_departments_committee_fk` (`committee_id`);
...
--
-- Indexes for table `pm_training_attendance`
--
ALTER TABLE `pm_training_attendance`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_attendance` (`pm_training_request_id`,`user_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_attendance_request` (`pm_training_request_id`),
  ADD KEY `idx_attendance_attended` (`attended`);

--
-- Indexes for table `pm_training_requests`
--
ALTER TABLE `pm_training_requests`
  ADD PRIMARY KEY (`id`),
  ADD KEY `requester_id` (`requester_id`),
  ADD KEY `idx_pm_requests_requester` (`requester_id`),
  ADD KEY `idx_pm_requests_status` (`status`),
  ADD KEY `idx_pm_requests_dates` (`date_start`,`date_end`),
  ADD KEY `idx_pm_requests_created` (`created_at`),
...
ALTER TABLE `user_departments`
  ...
  ADD KEY `committee_id` (`committee_id`),
  ADD KEY `idx_user_dept_user` (`user_id`),
  ADD KEY `idx_user_dept_dept` (`dept_id`);
...
--
-- AUTO_INCREMENT for table `pm_training_attendance`
--
ALTER TABLE `pm_training_attendance`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;

--
-- AUTO_INCREMENT for table `pm_training_requests`
--
ALTER TABLE `pm_training_requests`
...
--
-- Constraints for table `pm_training_attendance`
--
ALTER TABLE `pm_training_attendance`
  ADD CONSTRAINT `pm_training_attendance_ibfk_1` FOREIGN KEY (`pm_training_request_id`) REFERENCES `pm_training_requests` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pm_training_attendance_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `pm_training_requests`
--
ALTER TABLE `pm_training_requests`
  ADD CONSTRAINT `fk_pm_training_requests_committee` FOREIGN KEY (`committee_id`) REFERENCES `committees` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `pm_training_requests_ibfk_1` FOREIGN KEY (`requester_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
