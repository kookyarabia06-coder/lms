...
if ($act === 'addform' && $_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (strpos($e->getMessage(), 'Field id doesn\'t have a default value') !== false) {
            die('Error: The courses table needs to have an auto-increment id. Please run: ALTER TABLE courses MODIFY id INT AUTO_INCREMENT;');
        } else {
            throw $e;
        }
    }
    ...
    <div class="card p-4 mb-4 shadow-sm bg-white rounded">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="multiple-select-hint">
                    <i class="fas fa-info-circle"></i> You can select multiple departments
                </div>
            </div>
